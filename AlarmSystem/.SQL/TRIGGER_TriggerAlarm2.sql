...
IF(@TagId=@TagValueId)
select @AlarmLowerLimit = AlarmLowerLimit from ALARMCONFIGURATION where AlarmName='Warning'
select @AlarmUpperLimit = AlarmUpperLimit from ALARMCONFIGURATION where AlarmName='Warning'
select @AlarmName = AlarmName from ALARMCONFIGURATION where AlarmName='Warning'
